...
/*   Updated: 2023/04/19 02:43:36 by cnascime         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	forksinhand(t_journal *philosopher)
{
	...
	{
		grabfork(philosopher, philosopher->next);
		forksinhand++;
	}
	grabfork(philosopher, philosopher);
	forksinhand++;
	return (forksinhand);
}
...
int	fullbelly(t_journal *philosopher)
{
	...
	if (philosopher->meals == philosopher->timers->mandatorymeals)
	{
		...
		if (philosopher->mutexes->stillhungry == 0)
		{
